...
function peskyrealm_files() {
  wp_enqueue_script('main-peskyrealm-javascript', get_theme_file_uri("/js/scripts-bundled.js"), NULL, '1.0', true);
...
function peskyrealm_adjust_queries($query) {
...
add_action('pre_get_posts', 'peskyrealm_adjust_queries');
